    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bt_newchat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ( place == null){
                    chatroom = new Chatroom(MeetingActivity.me, 8, et_newchatTitle.getText().toString(), keywordlist);
                }else {
                    chatroom = new Chatroom(MeetingActivity.me, 8, et_newchatTitle.getText().toString(), keywordlist, place);

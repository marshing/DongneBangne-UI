...
public class BoardroomActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(postNum != -1){
            ...
            tv_boardroomTitle.setText(post.title);
            tv_boardroomContent.setText(post.content);
            tv_boardroomDate.setText(df.format(post.createdDate));
            tv_boardroomRecommendcount.setText(""+post.commentList.size());
            tv_boardroomThumbcount.setText(""+post.thumb);
